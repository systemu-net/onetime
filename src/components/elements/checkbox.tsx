...
const colors = {
    ...
    violet:
        '[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.violet.600)] [--checkbox-checked-border:theme(colors.violet.700/90%)]',
    purple:
...
export function Checkbox({
    ...
    return (
        <Headless.Checkbox
            data-slot="control"
            {...props}
            className={clsx(className, 'group inline-flex focus:outline-none cursor-pointer')}
        >
