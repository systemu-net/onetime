...
const PublishComponent: React.FC<PublishComponentProps> = ({
  ...
  const handleUnpublish = useCallback(async () => {
    ...
    if (!confirm('Are you sure you want to unpublish this page? It will no longer be accessible via the public URL.')) {
      return;
    }
    ...
    try {
      ...
      const response = await unpublishPage(cookies.token, page.published_lookup_code);
      if (response.success && response.data && onStatusChange) {
        onStatusChange(response.data);
        ...
        <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm text-blue-900">
              ...
              <p>Publishing will make your page publicly accessible. You can unpublish it at any time.</p>
            </div>
          </div>
        </div>
      )}
