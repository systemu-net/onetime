    ...
    <div className="bg-white dark:bg-zinc-900 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-base font-semibold leading-7 text-indigo-600 dark:text-indigo-400">Developer Resources</h2>
        ...
        <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="rounded-2xl border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 p-8 shadow-sm transition-shadow hover:shadow-md">
            <div className="mb-4 text-indigo-600 dark:text-indigo-400">
              <LiaLinkSolid size={40} />
            </div>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-zinc-100">Link Resources</h3>
            ...
            <ul className="mt-6 space-y-2">
              <li className="flex gap-x-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="rounded-2xl border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 p-8 shadow-sm transition-shadow hover:shadow-md">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-zinc-100">QR Code Resources</h3>
            <p className="mt-3 text-sm leading-6 text-gray-600 dark:text-gray-400">
          ...
          <div className="rounded-2xl border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 p-8 shadow-sm transition-shadow hover:shadow-md">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-zinc-100">Page Resources</h3>
            <p className="mt-3 text-sm leading-6 text-gray-600 dark:text-gray-400">
        ...
        <div className="mx-auto mt-20 max-w-7xl">
          <div className="rounded-3xl bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950 dark:to-purple-950 p-8 lg:p-12">
            <div className="mx-auto max-w-3xl text-center">
              <h3 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-zinc-100 sm:text-3xl">
            ...
            <div className="mx-auto mt-12 grid max-w-5xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center text-center">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-indigo-600 dark:bg-indigo-500 text-white">
                ...
                <h4 className="mt-4 text-sm font-semibold text-gray-900 dark:text-zinc-100">Full CRUD Operations</h4>
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                  Create, read, update, and delete all resource types
                </p>
                <span className="mt-2 inline-flex items-center rounded-full bg-blue-100 dark:bg-blue-900 px-2 py-0.5 text-xs font-medium text-blue-700 dark:text-blue-300">
                  Coming Soon
                </span>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="mt-4 text-sm font-semibold text-gray-900 dark:text-zinc-100">Drag & Drop Reordering</h4>
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="mt-4 text-sm font-semibold text-gray-900 dark:text-zinc-100">JWT Authentication</h4>
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="mt-4 text-sm font-semibold text-gray-900 dark:text-zinc-100">Comprehensive Docs</h4>
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="mt-4 text-sm font-semibold text-gray-900 dark:text-zinc-100">Rate Limiting</h4>
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="mt-4 text-sm font-semibold text-gray-900 dark:text-zinc-100">Webhooks</h4>
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
        ...
        <div className="mx-auto mt-20 max-w-5xl relative">
          ...
          <div className="relative rounded-xl bg-gray-900 dark:bg-zinc-950 p-6 shadow-xl">
            {/* Overlay */}
            <div className="absolute inset-0 bg-gray-900/80 dark:bg-zinc-950/80 backdrop-blur-sm rounded-xl flex items-center justify-center z-10">
              <div className="text-center px-6">
                <span className="inline-flex items-center rounded-full bg-blue-100 dark:bg-blue-900 px-4 py-2 text-sm font-medium text-blue-700 dark:text-blue-300 shadow-lg">
                  Coming Soon
                </span>
...
console.log(data.resources);`}</code>
        ...
        <div className="mx-auto mt-20 max-w-2xl text-center relative">
          {/* Overlay */}
          <div className="absolute inset-0 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-sm rounded-2xl flex items-center justify-center z-10">
            <div className="text-center px-6">
              <span className="inline-flex items-center rounded-full bg-blue-100 dark:bg-blue-900 px-4 py-2 text-sm font-medium text-blue-700 dark:text-blue-300 shadow-lg">
                Coming Soon
              </span>
